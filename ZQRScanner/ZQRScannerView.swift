...
class ZQRScannerView: UIView {
    ...
    public func configure(delegate: ZQRScannerViewDelegate, input: Input = .default) {
    ...
    private weak var delegate: ZQRScannerViewDelegate?
    ...
    private func failure(_ error: ZQRScannerError) {
...
extension ZQRScannerView: AVCaptureMetadataOutputObjectsDelegate {
...
extension ZQRScannerView: AVCaptureVideoDataOutputSampleBufferDelegate {
